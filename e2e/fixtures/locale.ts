...
const copy: Record<ProductionLocale, Record<string, string>> = {
  en: {
    ...
    inbox: "Inbox", compose: "Compose message", composeButton: "Compose", to: "To", subject: "Subject", attach: "Attach file", saveDraft: "Save draft", saved: "Saved to server", send: "Send message",
    ...
    preferences: "Language & region", language: "Language", english: "English", chinese: "简体中文", administration: "Administration", users: "Users",
  },
  "zh-CN": {
    loginTitle: "登录您的邮件工作区。", email: "电子邮件地址", password: "密码", submit: "进入工作区",
    inbox: "收件箱", compose: "撰写邮件", composeButton: "撰写邮件", to: "收件人", subject: "主题", attach: "添加附件", saveDraft: "保存草稿", saved: "已保存到服务器", send: "发送邮件",
    ...
    preferences: "语言与地区", language: "语言", english: "English", chinese: "简体中文", administration: "管理", users: "用户",
  },
};
