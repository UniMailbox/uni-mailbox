...
const copy: Record<ProductionLocale, Record<string, string>> = {
  en: {
    loginTitle: "Sign in to your mail plane.",
    email: "Email address",
    password: "Password",
    ...
    attachmentReady: "1 attachment ready",
    reply: "Reply",
    mailboxes: "Mailboxes",
    share: "Share mailbox",
    ...
    storageTitle: "Infrastructure",
    kvActive: "KV storage is active",
    kvHealthy: "KV healthy",
    verifyR2: "Verify R2 write access",
    signOut: "Sign out",
    userMenu: "Open user menu",
    accountEmail: "New login email",
    currentPassword: "Current password",
    updateEmail: "Update login email",
    notFound: "This page was not found",
    forbidden: "You do not have access to this area",
    cloudflareTitle: "Cloudflare Mail",
    controlPlane: "Connect the control plane",
    domainHeading: "Email Routing domain",
    finishCloudflare: "Finish setup in Cloudflare",
    openEmailRouting: "Open Email Routing",
    brevo: "Connect Brevo",
  ...
  "zh-CN": {
    ...
    notFound: "未找到此页面",
    forbidden: "您无权访问此区域",
    cloudflareTitle: "Cloudflare 邮件",
    controlPlane: "连接控制平面",
    domainHeading: "Email Routing 域名",
    finishCloudflare: "在 Cloudflare 中完成设置",
    openEmailRouting: "打开 Email Routing",
    brevo: "连接 Brevo",
    preferences: "语言与地区",
    settings: "设置",
    language: "语言",
...
export const test = base.extend<{ uiLocale: LocaleFixture }>({
  context: async ({ context }, use, testInfo) => {
    await initializeProjectLocale(
      context,
      projectLocale(testInfo.project.name),
    );
    await use(context);
  },
  uiLocale: [
