...
describe("LoginPage bidi inputs", () => {
  it("keeps the login email LTR in the pseudo-RTL locale", () => {
    render(<I18nextProvider i18n={createTestI18n("ar-XB")}><QueryClientProvider client={new QueryClient({ defaultOptions: { mutations: { retry: false } } })}><LoginPage /></QueryClientProvider></I18nextProvider>);
