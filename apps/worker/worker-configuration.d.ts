/* eslint-disable */
// Generated by Wrangler by running `wrangler types apps/worker/worker-configuration.d.ts` (hash: 3223f676cc4cd37545a0f3090e9ce4d5)
...
interface __BaseEnv_Env {
	...
	MAILBOX_AGENT: DurableObjectNamespace /* MailboxAgent */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MailboxAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SENTRY_ENVIRONMENT" | "SENTRY_SAMPLE_RATE" | "SENTRY_TRACES_SAMPLE_RATE">> {}
}
